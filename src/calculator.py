"""Minimal CJdropshipping API client for backend usage.

Set the environment variable ``CJ_API_KEY`` before running this module,
or pass the API key directly to ``authenticate`` / ``ensure_token``.
"""
