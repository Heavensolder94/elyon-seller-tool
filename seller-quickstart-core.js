...
export const QUICKSTART_SECONDARY_LINKS = Object.freeze([
  Object.freeze({ id: "jarvis", icon: "◉", label: "JARVIS / Brain Control", description: "Jarvis Command Center, Brain Health, Dateien, Drafts und Freigaben öffnen.", tab: "jarvisCommandCenterTab" }),
