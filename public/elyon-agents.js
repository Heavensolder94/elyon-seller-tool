...
(function(){
  ...
  window.openVirtualAgentsSettings = openAgentSettings;
  window.renderVirtualAgentsSettings = render;
  window.reloadVirtualAgentsSettings = window.__elyonAgentsApi.reloadSettings;

  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initVirtualAgents, { once: true });
  } else {
    initVirtualAgents();
  }
})();
