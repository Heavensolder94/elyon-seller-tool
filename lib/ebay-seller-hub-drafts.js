...
// eBay currently routes Seller Hub draft creation through FX_DRAFT.
// Using FX_LISTING with Action=Draft is accepted at upload time but later fails with
// BAF.Error.5 ("Unable to find Task Action Id for task Draft") for affected accounts.
...
export function buildSellerHubDraftCsv(input = {}) {
  ...
  return {
    // The Seller Hub draft template is UTF-8 without BOM, CRLF terminated.
