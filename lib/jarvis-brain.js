...
function extractBrainPayload(raw) {
  ...
  if (!parsed) return { answer: text(raw, 12000), memory: null };
...
function brainSystemPrompt() {
  return [
    "You are Elyon Jarvis Brain V1, the central business assistant and orchestrator for the Elyon Seller Tool.",
    ...
    '{"answer":"string","memory":{"shouldStore":false,"memoryType":"business_rule|decision|experience|preference|workflow_state|system_fact|conversation_summary|user_instruction|agent_learning|product_learning","summary":"string","importance":0.0,"confidence":0.0}}',
