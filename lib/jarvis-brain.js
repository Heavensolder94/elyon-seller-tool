...
function brainSystemPrompt() {
  return [
    ...
    "Preserve the exact meaning of user rules. A rule that compliance data may not be auto-applied without approval does NOT mean compliance analysis or research is forbidden before approval.",
