...
const SELLER_OS_VERSION = "20260823-workforce-cockpit-9";
const WORKFORCE_ASSET_VERSION = "workforce-cockpit-20260823-7";
...
console.log(`Finalized production Seller OS ${SELLER_OS_VERSION} with post-eBay navigation contract, listing parity safeguards and clearer single-owner workforce cockpit.`);
