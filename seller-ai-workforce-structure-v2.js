(() => {
  ...
  const AGENTS = [
    { id: "elyon-manager", name: "Elyon Manager", icon: "🧠", group: "manager", phase: 0, backendId: "elyon-operations-manager", provider: "deepseek", action: "run_manager", role: "Zentrale Steuerung: bewertet den Workflow, erkennt Blocker und empfiehlt den nächsten Fachagenten." },
    ...
    { id: "elyon-order-specialist", name: "Order Coordinator", icon: "📦", group: "operations", phase: 3, backendId: "elyon-order-coordinator", provider: "deepseek", action: "analyze_order", role: "Überwacht Bestellungen, Versandfristen, Tracking-Lücken und Lieferantenrisiken." },
